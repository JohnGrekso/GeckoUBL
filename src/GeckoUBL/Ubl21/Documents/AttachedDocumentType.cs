...
namespace GeckoUBL.Ubl21.Documents
{
	...
	public class AttachedDocumentType {
		...
		public ParentDocumentIDType ParentDocumentID {
			get {
				return parentDocumentIDField;
			}
			set {
				parentDocumentIDField = value;
			}
		}
		...
		public ParentDocumentTypeCodeType ParentDocumentTypeCode {
			get {
				return parentDocumentTypeCodeField;
			}
			set {
				parentDocumentTypeCodeField = value;
			}
		}
		...
		public ParentDocumentVersionIDType ParentDocumentVersionID {
			get {
				return parentDocumentVersionIDField;
			}
			set {
				parentDocumentVersionIDField = value;
			}
		}
		...
		public LineReferenceType[] ParentDocumentLineReference {
			get {
				return parentDocumentLineReferenceField;
			}
			set {
				parentDocumentLineReferenceField = value;
			}
		}
	}
}