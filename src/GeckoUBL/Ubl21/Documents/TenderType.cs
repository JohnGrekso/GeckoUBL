...
namespace GeckoUBL.Ubl21.Documents
{
	...
	public class TenderType {
		...
		public TenderTypeCodeType TenderTypeCode {
			get {
				return tenderTypeCodeField;
			}
			set {
				tenderTypeCodeField = value;
			}
		}
		...
		public PartyType TendererParty {
			get {
				return tendererPartyField;
			}
			set {
				tendererPartyField = value;
			}
		}
		...
		public DocumentReferenceType TendererQualificationDocumentReference {
			get {
				return tendererQualificationDocumentReferenceField;
			}
			set {
				tendererQualificationDocumentReferenceField = value;
			}
		}
		...
		public PartyType[] SubcontractorParty {
			get {
				return subcontractorPartyField;
			}
			set {
				subcontractorPartyField = value;
			}
		}
		...
		public TenderedProjectType[] TenderedProject {
			get {
				return tenderedProjectField;
			}
			set {
				tenderedProjectField = value;
			}
		}
	}
}