...
namespace GeckoUBL.Ubl21.Documents
{
	...
	public class TenderReceiptType {
		...
		public RegisteredDateType RegisteredDate {
			get {
				return registeredDateField;
			}
			set {
				registeredDateField = value;
			}
		}
		...
		public RegisteredTimeType RegisteredTime {
			get {
				return registeredTimeField;
			}
			set {
				registeredTimeField = value;
			}
		}
		...
		public DocumentReferenceType[] TenderDocumentReference {
			get {
				return tenderDocumentReferenceField;
			}
			set {
				tenderDocumentReferenceField = value;
			}
		}
