...
namespace GeckoUBL.Ubl21.Documents
{
	...
	public class TransportExecutionPlanType {
		...
		public TransportServiceProviderRemarksType[] TransportServiceProviderRemarks {
			get {
				return transportServiceProviderRemarksField;
			}
			set {
				transportServiceProviderRemarksField = value;
			}
		}
		...
		public PartyType BillToParty {
			get {
				return billToPartyField;
			}
			set {
				billToPartyField = value;
			}
		}
		...
		public DocumentReferenceType TransportExecutionPlanRequestDocumentReference {
			get {
				return transportExecutionPlanRequestDocumentReferenceField;
			}
			set {
				transportExecutionPlanRequestDocumentReferenceField = value;
			}
		}
		...
		public PeriodType TransportServiceProviderResponseRequiredPeriod {
			get {
				return transportServiceProviderResponseRequiredPeriodField;
			}
			set {
				transportServiceProviderResponseRequiredPeriodField = value;
			}
		}
		...
		public PeriodType[] TransportUserResponseRequiredPeriod {
			get {
				return transportUserResponseRequiredPeriodField;
			}
			set {
				transportUserResponseRequiredPeriodField = value;
			}
		}
