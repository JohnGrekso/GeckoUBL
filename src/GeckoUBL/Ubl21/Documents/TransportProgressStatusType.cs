...
namespace GeckoUBL.Ubl21.Documents
{
	...
	public class TransportProgressStatusType {
		...
		public StatusAvailableIndicatorType StatusAvailableIndicator {
			get {
				return statusAvailableIndicatorField;
			}
			set {
				statusAvailableIndicatorField = value;
			}
		}
		...
		public PartyType SourceIssuerParty {
			get {
				return sourceIssuerPartyField;
			}
			set {
				sourceIssuerPartyField = value;
			}
		}
		...
		public DocumentReferenceType TransportProgressStatusRequestDocumentReference {
			get {
				return transportProgressStatusRequestDocumentReferenceField;
			}
			set {
				transportProgressStatusRequestDocumentReferenceField = value;
			}
		}
		...
		public TransportScheduleType[] TransportSchedule {
			get {
				return transportScheduleField;
			}
			set {
				transportScheduleField = value;
			}
		}
	}
}